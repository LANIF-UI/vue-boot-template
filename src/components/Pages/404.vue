<template>
  <div class="page404">
	...
	c-11.4,0-20.6-9.2-20.6-20.6c0-11.4,9.2-20.6,20.6-20.6h21.2c11.4,0,20.6,9.2,20.6,20.6C353.3,177.9,344.1,187.1,332.8,187.1z"
      ...
      <g id="triforce">
        ...
        <path
          ...
          class="st2"
          d="M175.4,59.5l-18.5,10.7l-18.5-10.7H175.4z M175.4,59.5l18.5,10.7l18.5-10.7H175.4z M156.9,91.5l18.5,10.7l18.5-10.7H156.9z"
        />
        <path
          id="zelda_highlight"
          class="st3"
          d="M150.6,66.6h12.5l-6.3,10.8L150.6,66.6z M193.8,77.4l6.3-10.8h-12.5L193.8,77.4z M175.4,109.4l6.3-10.8h-12.5L175.4,109.4z"
        />
      </g>
      <g id="monkey">
        <path
    ...
    <a href="">
      <el-button class="btn--home" icon="el-icon-thumb" type="primary" plain round>Back to home</el-button>
    </a>
  </div>
</template>
